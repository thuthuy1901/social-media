    ...
    variants: {
      variant: {
        ...
        transformToBottomBox:
          "relative -top-1 -left-1 bg-green-main font-semibold uppercase text-white transition-all before:absolute before:top-1 before:left-1 before:-z-10 before:h-full before:w-full before:border-2 before:border-green-main before:transition-all before:content-[''] hover:top-0 hover:left-0 before:hover:top-0 before:hover:left-0",
      },
      size: {
